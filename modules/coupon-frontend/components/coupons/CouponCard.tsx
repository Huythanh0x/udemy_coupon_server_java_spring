...
import { Star, Users, Clock, Briefcase, Code, TrendingUp, Laptop, FileText, User, Palette, Megaphone, Heart, Camera, Dumbbell, Music, GraduationCap, Book, ExternalLink } from 'lucide-react'
      ...
      <div className="bg-white dark:bg-card border border-gray-200 dark:border-border rounded-[10px] shadow-[0_4px_6px_rgba(0,0,0,0.1)] overflow-hidden transition-transform duration-300 hover:-translate-y-[5px] hover:shadow-lg relative cursor-pointer">
        ...
        <div className="p-4">
          ...
          <div className="flex justify-between items-center gap-2.5 mb-3">
            ...
            <p className="text-xs text-gray-700 dark:text-gray-300 font-medium text-right flex-shrink-0 italic underline">
              {course.author.length > 25 ? `${course.author.substring(0, 25)}...` : course.author}
            </p>
          </div>
          ...
          <button
            ...
            className="w-full py-2.5 px-4 bg-primary text-primary-foreground rounded-lg font-semibold hover:bg-primary/90 transition-colors flex items-center justify-center gap-2 shadow-md hover:shadow-lg"
          >
